...
ActiveRecord::Schema[8.0].define(version: 2019_04_01_161715) do
  ...
  create_table "boots", force: :cascade do |t|
    ...
    t.index ["layout_id"], name: "index_boots_on_layout_id"
    t.index ["parent_id"], name: "index_boots_on_parent_id"
    t.index ["site_id"], name: "index_boots_on_site_id"
  end
  ...
  create_table "faqs", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["site_id"], name: "index_faqs_on_site_id"
  end
  ...
  create_table "fields", force: :cascade do |t|
    ...
    t.index ["site_id"], name: "index_fields_on_site_id"
  end
  ...
  create_table "forms", force: :cascade do |t|
    ...
    t.index ["site_id"], name: "index_forms_on_site_id"
  end
  ...
  create_table "incoming_calls", force: :cascade do |t|
    ...
    t.index ["called"], name: "index_incoming_calls_on_called"
    t.index ["calling"], name: "index_incoming_calls_on_caller"
    t.index ["contact_id"], name: "index_incoming_calls_on_contact_id"
    t.index ["sid"], name: "index_incoming_calls_on_sid"
    t.index ["site_id"], name: "index_incoming_calls_on_site_id"
  end
  ...
  create_table "outgoing_calls", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["contact_id"], name: "index_outgoing_calls_on_contact_id"
    t.index ["sid"], name: "index_outgoing_calls_on_sid"
    t.index ["site_id"], name: "index_outgoing_calls_on_site_id"
    t.index ["user_id"], name: "index_outgoing_calls_on_user_id"
  end
  ...
  create_table "paths", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.integer "status", limit: 4
    t.index ["session_id"], name: "index_paths_on_session_id"
    t.index ["site_id"], name: "index_paths_on_site_id"
  end
  ...
  create_table "recordings", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["incoming_call_id"], name: "index_recordings_on_incoming_call_id"
  ...
  create_table "twilio_configs", force: :cascade do |t|
    ...
    t.index ["site_id"], name: "index_twilios_on_site_id"
  end
