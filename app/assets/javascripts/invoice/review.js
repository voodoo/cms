...
$('#frm-review-satisfied').validator().on('submit', function(e){

  e.preventDefault()

  var satisfied                = 1
  var comment                  = $('#review_comment_satisfied').val()
  ...
  // Fixed last bug /sigh
  var data = {review:{satisfied: satisfied, comment: comment, original_comment: comment}}
  
  var url = $INVOICE_URL + "/customer_reviews"
...
$('#frm-review-unsatisfied').validator().on('submit', function(e){

  e.preventDefault()

  var satisfied                = 0
  var comment                  = $('#review_comment_unsatisfied').val()
  var dContainer               = $('#confirmation-container')
