Rails.application.configure do
  ...
  #config.middleware.use Rack::TwilioWebhookAuthentication, Rails.application.secrets["twilio"]["token"], '/twilios'
  ...
  # Asset compression (Propshaft handles this differently)
